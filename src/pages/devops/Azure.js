...
import awspic from '../../assets/awspagecopyazure.png'
import Header from '../../components/Header'
import Footer from '../../components/Footer'
import aws2 from '../../assets/azure1.png'
import aws3 from '../../assets/azure2.jpg'
    ...
    return (
        <>
            ...
            <Grid container sx={{ backgroundPosition: 'center', bgcolor: '#595959 ', backgroundBlendMode: 'multiply', p: '150px', backgroundImage: `url(${awspic})`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain' }}>
                <Grid item>
                    <Typography variant='h1' sx={{ color: 'white', fontWeight: 900 }}>AZURE</Typography>
                </Grid>
            </Grid>
            ...
            <Grid container sx={{ justifyContent: 'center', m: '50px 50px', pr: '100px' }}>
                <Grid item sx={{ width: '50%' }}>
                    <Typography paragraph textAlign={'left'} sx={{ fontSize: '15px' }}>
                        <span style={{ fontSize: '40px', color: MAIN_COLOR }}>Cloud computing with AZURE</span> <br />Amazon Web Services (AZURE) is the world’s most comprehensive and broadly adopted cloud, offering over 200 fully featured services from data centers globally. Millions of customers—including the fastest-growing startups, largest enterprises, and leading government agencies—are using AWS to lower costs, become more agile, and innovate faster.
                    </Typography>
                </Grid>
                <Grid item sx={{ width: '50%' }}>
