...
import awspic from '../../assets/awspagecopy.jpg'
import Header from '../../components/Header'
import Footer from '../../components/Footer'
import aws2 from '../../assets/gcp1.png'
import aws3 from '../../assets/gcp2.png'
...
const Gcp = () => {
    return (
        <>
            <Header />
            <Grid container sx={{ bgcolor: '#595959 ', backgroundBlendMode: 'multiply', p: '150px', backgroundImage: `url(${awspic})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <Grid item>
                    <Typography variant='h1' sx={{ color: 'white', fontWeight: 900 }}>GCP</Typography>
                </Grid>
            </Grid>
            <Grid container sx={{ justifyContent: 'center', m: '50px 50px', pr: '100px' }}>
                <Grid item sx={{ width: '50%' }}>
                    <img width={'96%'} height={'90%'} src={aws2} alt='pic' style={{ borderRadius: '100px', boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)' }} />
                </Grid>
                <Grid item sx={{ width: '50%' }}>
                    <Typography paragraph textAlign={'left'} sx={{ fontSize: '15px' }}>
                        <span style={{ fontSize: '40px', color: MAIN_COLOR, fontWeight: 900 }}>Gcp Content Analysis</span> <br />Gcp Content Analysis is an AWS Solutions Implementation that customers can use to obtain a broader understanding of their media content through machine learning. The solution brings together the capabilities of different AWS machine learning tools to generate meaningful insights from metadata gleaned through video analysis. Customers can use the solutions implementation, modify it to fit their own workflows and build their own analytical solutions for media in the AWS Cloud.
            ...
            <Grid container sx={{ justifyContent: 'center', m: '50px 50px', pr: '100px' }}>
                <Grid item sx={{ width: '50%' }}>
                    <Typography paragraph textAlign={'left'} sx={{ fontSize: '15px' }}>
                        <span style={{ fontSize: '40px', color: MAIN_COLOR, fontWeight: 900 }}>Cloud computing with Gcp</span> <br />Amazon Web Services (Gcp) is the world’s most comprehensive and broadly adopted cloud, offering over 200 fully featured services from data centers globally. Millions of customers—including the fastest-growing startups, largest enterprises, and leading government agencies—are using AWS to lower costs, become more agile, and innovate faster.
                    </Typography>
                </Grid>
                <Grid item sx={{ width: '50%' }}>
