    ...
    return (
        ...
        <>
            ...
            <Grid container >
                <Grid item xs={12} sx={{ backgroundImage: `url(${Laravel})`, backgroundBlendMode: "multiply", backgroundRepeat: "no-repeat", backgroundSize: "cover", bgcolor: "rgba(0, 0, 0, 0.5)", p: "50px" }}>
                    ...
                    <Grid container sx={{ p: "10px" }}>
                        ...
                        <Grid item xs={12} lg={5} sx={{ mt:  { xs: "70px", sm: "70px", md: "70px", lg: "55px" }, display: { xs: "none", sm: "none", md: "none", lg: "flex" }, justifyContent:'center', alignItems:'center', }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", p: "10px", mt: {lg:"-45px", md:'0', sm:'', xs:''},  }}>
                ...
                <Grid container sx={{ p: "20px" , justifyContent:'space-evenly', alignItems:'center'}} >
                ...
                <Grid item xs={12} md={5} lg={5} sx={{display:'flex', justifyContent:'center', alignItems:'center', mt:{xs:'10px'}}}>
                    ...
                    <Box  data-aos='fade-up' sx={{ height:{lg: "320px",md:'300px',sm:'300px',xs:'300px'}, width: { xs: "100%", sm: "85%", md: "80%", lg: "80%" }, borderRadius: "25px", overflow: "hidden",boxShadow: '0px 0px 5px 0px rgba(0,0,0,0.75)' }}>
                            <img src={LaravelHire} height="100%" width="100%" alt='img3' style={{objectFit:'cover'}}/>
                        </Box>
                </Grid>
            </Grid>
